...
@section('content')
      ...
      <div class="am-form-group am-cf">
        ...
        <div class="am-popup am-popup-inner" id="my-popups">
          <div class="am-popup-hd">
            <h4 class="am-popup-title">修改轮播图</h4>
            <span data-am-modal-close class="am-close">&times;</span> </div>
          <div class="am-popup-bd">
            <form class="am-form tjlanmu" action="{{url('/admin/fenlei/{id}')}}" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="am-form-group am-cf">
                <div class="zuo">栏目图片：</div>
        <div class="you" style="height: 45px;">
...
<div class="admin-biaogelist">
  <div class="listbiaoti am-cf">
    ...
    <dl>
      <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" data-am-modal="{target: '#my-popup'}"> 添加轮播图</button>
    </dl>
  ...
  <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
    ...
    @foreach($cc as $v)
      <tr >
        ...
        <td ><img src="/uploads/{{$v->pic}}" style="width: 100px;height: 100px;" alt=""></td>
        <td>{{$v->created_at}}</td>
        ...
        <td>
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              ...
              <a href="/admin/fenlei/{{$v->id}}/edit"><button class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="添加（随机虚拟用户ID ）"><span class="am-icon-pencil-square-o" >修改</span></button></a>
              ...
              <form action="/admin/fenlei/{{$v->id}}" method="post">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round"  title="删除"><span class="am-icon-trash-o">删除</span></button>
              </form>
            </div>
          </div>
        </td>
