                ...
                <div class="page-container">
                    ...
                    <div class="pure-g">
                        ...
                        <div class="pure-u-2-3 main-panel">
                            ...
                            <h1 class="page-title">创建一个新菜单</h1>

                            <div class="block block-has-padding white-bg">
                                <div class="title-bar">
                                    <div class="red-font large-font bold-font">
                                    </div>
                                </div>

                                <form enctype="multipart/form-data" action="{{url('/home/chufang/storecaidan')}}" method="POST" class="aligned-form">
                                    {{csrf_field()}}
                                    <fieldset>
                                        <div class="control-group">
                                            <label class="label" for="title">菜单标题</label>
                                            <input type="text" name="title" id="title" maxlength="32" class="control" value="">
                                        </div>
                                        <div class="control-group">
                                            <label class="label" for="description">描述</label>
                                            <textarea name="description" id="description" class="control" rows="15"></textarea>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <div class="label">&nbsp;</div>
                                            <div class="control">
                                                <input type="file" class="hidden" name="img" id="pic">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <div class="label">&nbsp;</div>
                                            <div class="control">
                                                <input type="submit" class="button" value="创建菜单">
                                            </div>
                                        </div>
