            ...
            <div class="recipe pure-g">
                <div class="cover pure-u">
                    <a href="http://www.xiachufang.com/recipe/102253335/" class="image-link" target="_blank">
                        <img src="/home/recipe/upload/{{$v->cook_book->pic}}" data-src="http://s2.cdn.xiachufang.com/34c5e14c1c0a11e7947d0242ac110002_1280w_1023h.jpg?imageView2/1/w/215/h/138/interlace/1/q/90" width="215" height="138" alt="法式吐司配草莓酱" class="unveiled">
                    </a>
                </div>
                <div class="info pure-u">
                    <p class="name">
                        <a href="http://www.xiachufang.com/recipe/102253335/" target="_blank">{{$v->cook_book->title}}</a>
                        <i class="step-icon"></i>
                    </p>
                    ...
                    <input type="hidden" value="{{$v['bid']}}" name="" id="bid">
                    <input type="hidden" value="{{$v['uid']}}" name="" id="uid">
